...
const client: Axios = createAxios(`${import.meta.env.VITE_API_LOCAL_URL}:${import.meta.env.VITE_API_LOCAL_PORT_TEST}`)
const graphqlClient: Axios = createAxios(`${import.meta.env.VITE_API_LOCAL_URL}:${import.meta.env.VITE_API_LOCAL_PORT_TEST}/graphql`)
